 ...
 * @author wajdi
 */
public class CardFormationFormateurController implements Initializable {
    ...
    @FXML
    private ImageView ModifFormationId;
    @FXML
    ...
    @FXML
    private void handleModifFormation(MouseEvent event) {
        ...
        if (event.getSource() == ModifFormationId) {
            f = fs.getFormationById(idFormation);
            ...
            try {
                ...
                loader.setLocation(getClass().getResource("/views/ModifierFormation.fxml"));
