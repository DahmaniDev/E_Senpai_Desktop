...
public class TestEtudiantController implements Initializable {
    ...
    @FXML
    private Button acuueilBtn;
    
    public void initData(User u){
        welcomeLabel.setText("Bienvenue "+u.getNom().get() +"  "+ u.getPrenom().get());   
        idEtudiant.setText(u.getId().get()+"");
    ...
    @FXML
    private void handleAcuueilBtn(ActionEvent event) {
        try {
